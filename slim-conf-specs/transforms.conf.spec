#   Version 20251028a
#
# Added my modifications to clear the warnings about INGEST_EVAL
#
#   Version 20170103
#
...
INGEST_EVAL = <string>
* INGEST_EVAL expression to carry out transformations on the incoming logs.
* NOTE: This attribute is valid only for index-time field extraction.
